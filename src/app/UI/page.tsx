    ...
    return (
        <>
            ...
            <Container>
                ...
                <div className="flex p-5">
                    <Button className="m-2" size="large" variant="ico" iconTheme="primary"
                            icon={<RiUser6Fill/>}>Test</Button>
                    <Button className="m-2" size="large" variant="ico" iconTheme="secondary"
                            icon={<RiUser6Fill/>}>Test</Button>
                    <Button className="m-2" size="large" variant="ico" iconTheme="gray"
                            icon={<RiUser6Fill/>}>Test</Button>
                    <Spinner size="large"/>
                </div>
                ...
                <div className="flex p-5">
                    ...
                    <Button className="m-2" size="small" variant="ico" iconTheme="primary"
                            icon={<RiUser6Fill/>}>Test</Button>
                    <Button className="m-2" size="small" variant="ico" iconTheme="secondary"
                            icon={<RiUser6Fill/>}>Test</Button>
                    <Button className="m-2" size="small" variant="ico" iconTheme="gray"
                            icon={<RiUser6Fill/>}>Test</Button>
                    <Spinner size="small"/>
                </div>
                ...
                <div className="flex p-5">
                    ...
                    <Button isLoading className="m-2" size="small" variant="ico" iconTheme="primary"
                            icon={<RiUser6Fill/>}>Test</Button>
                    <Button isLoading className="m-2" size="small" variant="ico" iconTheme="secondary"
                            icon={<RiUser6Fill/>}>Test</Button>
                    <Button isLoading className="m-2" size="small" variant="ico" iconTheme="gray"
                            icon={<RiUser6Fill/>}>Test</Button>
                </div>
