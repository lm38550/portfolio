                ...
                <div className="p-5 border-b-2 border-day-300 dark:border-night-300">
                    ...
                    <div className="flex p-5 border-2 border-day-300 dark:border-night-300">
                        ...
                        <div className="flex p-5 items-center">
                            <Typography variant="h1">Ceci est un texte en H1. <br/> Voici un exemple de texte s'étallant
                                sur plusieurs lignes.</Typography>
                        </div>
                    </div>
                    <div className="flex p-5 border-2 border-day-300 dark:border-night-300">
                        <Typography variant="caption-sm">H2</Typography>
                        <div className="flex p-5 items-center">
                            <Typography variant="h2">Ceci est un texte en H2. <br/> Voici un exemple de texte s'étallant
                                sur plusieurs lignes.</Typography>
                        </div>
                    </div>
                    <div className="flex p-5 border-2 border-day-300 dark:border-night-300">
                        ...
                        <div className="flex p-5 items-center">
                            <Typography variant="h3">Ceci est un texte en H3. <br/> Voici un exemple de texte s'étallant
                                sur plusieurs lignes.</Typography>
                        </div>
                    </div>
                    <div className="flex p-5 border-2 border-day-300 dark:border-night-300">
                        ...
                        <div className="flex p-5 items-center">
                            <Typography variant="h4">Ceci est un texte en H4. <br/> Voici un exemple de texte s'étallant
                                sur plusieurs lignes.</Typography>
                        </div>
                    </div>
                    <div className="flex p-5 border-2 border-day-300 dark:border-night-300">
                        ...
                        <div className="flex p-5 items-center">
                            <Typography variant="h5">Ceci est un texte en H5. <br/> Voici un exemple de texte s'étallant
                                sur plusieurs lignes.</Typography>
                        </div>
                    </div>
                    <div className="flex">
                        <div className="w-[50%] p-5 border-2 border-day-300 dark:border-night-300 space-y-2">
                            ...
                            <div className="pb-5 space-y-2">
                                <Typography variant="body-xlg">Ceci est un texte en body XLARGE. <br/> Voici un exemple
                                    de texte s'étallant sur plusieurs lignes.</Typography>
                                <Typography variant="body-lg">Ceci est un texte en body LARGE. <br/> Voici un exemple de
                                    texte s'étallant sur plusieurs lignes.</Typography>
                                <Typography variant="body-base">Ceci est un texte en body BASE. <br/> Voici un exemple
                                    de texte s'étallant sur plusieurs lignes.</Typography>
                                <Typography variant="body-sm">Ceci est un texte en body SMALL. <br/> Voici un exemple de
                                    texte s'étallant sur plusieurs lignes.</Typography>
                            </div>
                        </div>
                        <div className="w-[50%] p-5 border-2 border-day-300 dark:border-night-300 space-y-2">
                            ...
                            <div className="pb-5 space-y-2">
                                <Typography variant="caption-lg">Ceci est un texte en caption LARGE. <br/> Voici un
                                    exemple de texte s'étallant sur plusieurs lignes.</Typography>
                                <Typography variant="caption-base">Ceci est un texte en caption BASE. <br/> Voici un
                                    exemple de texte s'étallant sur plusieurs lignes.</Typography>
                                <Typography variant="caption-sm">Ceci est un texte en caption SMALL. <br/> Voici un
                                    exemple de texte s'étallant sur plusieurs lignes.</Typography>
                                <Typography variant="caption-xsm">Ceci est un texte en caption XSMALL. <br/> Voici un
                                    exemple de texte s'étallant sur plusieurs lignes.</Typography>
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-5 border-b-2 border-day-300 dark:border-night-300">
                    ...
                    <div className="p-5 space-y-2 border-2 border-day-300 dark:border-night-300">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Button isLoading size="small" variant="ico" iconTheme="primary"
                                    icon={<RiUser6Fill/>}>Test</Button>
                            <Button isLoading size="small" variant="ico" iconTheme="secondary"
                                    icon={<RiUser6Fill/>}>Test</Button>
                            <Button isLoading size="small" variant="ico" iconTheme="gray"
                                    icon={<RiUser6Fill/>}>Test</Button>
                    ...
                    <div className="p-5 space-y-2 border-2 border-day-300 dark:border-night-300">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Button isLoading size="large" variant="ico" iconTheme="primary"
                                    icon={<RiUser6Fill/>}>Test</Button>
                            <Button isLoading size="large" variant="ico" iconTheme="secondary"
                                    icon={<RiUser6Fill/>}>Test</Button>
                            <Button isLoading size="large" variant="ico" iconTheme="gray"
                                    icon={<RiUser6Fill/>}>Test</Button>
                ...
                <div className="p-5 border-day-300 dark:border-night-300">
                    ...
                    <div className="flex">
                        <div className="flex-col w-[50%]">
                            <div className="p-5 border-2 border-day-300 dark:border-night-300 space-y-2">
